...
- CWD (the repo): `/tmp/claude-1000/-home-smoke01-dev-seza/a1db3155-9529-49c3-b157-9a385a8c7b55/scratchpad/ablation/UC3-3/repo`
- run-id: `ablation-UC3-3`
- journal: `/tmp/claude-1000/-home-smoke01-dev-seza/a1db3155-9529-49c3-b157-9a385a8c7b55/scratchpad/ablation/UC3-3/journal.jsonl`
- run manifest (already written by `init`): `/tmp/claude-1000/-home-smoke01-dev-seza/a1db3155-9529-49c3-b157-9a385a8c7b55/scratchpad/ablation/UC3-3/journal.jsonl.run.json`

Before any tool call, in every shell you use:

    export ANCIENT_GAMES_RUN=/tmp/claude-1000/-home-smoke01-dev-seza/a1db3155-9529-49c3-b157-9a385a8c7b55/scratchpad/ablation/UC3-3/journal.jsonl.run.json
