# Dispatch prompt — ablation 5 (GM1, re-run)

Identical to attempt 5's, with attempt 6's paths and the regenerated packet. Kept for the record.
...
- CWD (the repo): `/home/smoke01/.claude/jobs/bed6093b/tmp/ablation/GM1-6/repo`
- run-id: `ablation-GM1-6`
- journal: `/home/smoke01/.claude/jobs/bed6093b/tmp/ablation/GM1-6/journal.jsonl`
- run manifest (already written by `init`): `/home/smoke01/.claude/jobs/bed6093b/tmp/ablation/GM1-6/journal.jsonl.run.json`

Before any tool call, in every shell you use:

    export ANCIENT_GAMES_RUN=/home/smoke01/.claude/jobs/bed6093b/tmp/ablation/GM1-6/journal.jsonl.run.json
